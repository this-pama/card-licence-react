...
import RetailerApp from './retailer';
...
describe('CpLicenceApp snapshot', () => {
  it('test snapshot', () => {
    const component = renderer.create(<RetailerApp />);
...
describe('simulate events', () => {
  const wrapper = mount(<RetailerApp />);

  it('simulates click events', () => {
    const onButtonClick = sinon.spy();
    const wrapper = mount(<RetailerApp licence={onButtonClick} />);
