...
import LicenceApp from './licence';
...
describe('login app snapshot', () => {
  it('test snapshot', () => {
    const component = renderer.create(<LicenceApp />);
...
describe('simulate events', () => {
  const wrapper = mount(<LicenceApp />);

  it('simulates click events', () => {
    const onButtonClick = sinon.spy();
    const wrapper = mount(<LicenceApp licence={onButtonClick} />);
